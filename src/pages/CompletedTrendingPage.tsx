...
const TrendingCaseItem = memo(({ post, navigate }: any) => {
  ...
  return (
    <div style={{ backgroundColor: 'white', minHeight: '100vh', width: '100%', boxSizing: 'border-box' }}>
      <div style={{ padding: '0 20px', paddingTop: '16px', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
        <Asset.Image frameShape={Asset.frameShape.CleanW24} src="https://static.toss.im/2d-emojis/png/4x/u1F525.png" style={{ aspectRatio: '1/1' }} />
        <Text display="block" color={adaptive.grey900} typography="t3" fontWeight="bold" style={{ fontSize: '22px' }}>화제의 재판 기록</Text>
      </div>
